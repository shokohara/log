...
lazy val scalatestplusplay = "3.1.2"
lazy val shapelessVersion = "2.3.2"
lazy val simulacrumVersion = "0.10.0"
lazy val slickVersion = "3.2.1"
lazy val slicklessVersion = "0.3.2"

name := "log"
organization := "com.github.shokohara.log"
scalaVersion := "2.12.3"

lazy val strict: Boolean = sys.env.get("CI").isDefined
